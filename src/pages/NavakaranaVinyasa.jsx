  ...
  return (
    <div className="min-h-screen w-full bg-claro">
        ...
        <div className="w-[80vw] md:w-[60vw] items-center justify-items-center mx-auto">.
          <h3 className="w-text-xl md:text-3xl rounded font-quicksand text-oscuro text-center font-semibold uppercase py-2 md:w-[50vw]">GALLERY</h3>
        ...
        <section id="eventi" className="w-[80vw] md:w-[60vw] items-center justify-items-center mx-auto scroll-mt-24">
          <h3 className="w-text-xl md:text-3xl rounded font-quicksand text-oscuro text-center font-semibold uppercase py-2 md:w-[50vw] ">Guarda tutti gli eventi</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-4 p-12 text-center h-[500px]">
                <div className="flex-1 border-2 rounded-2xl  bg-red-500">
                    <div className="p-2 md:p-4">
                        <h2 className="font-quicksand text-base md:text-lg font-semibold text-[#581414] ">INFO DE EVENTOS</h2>
                        <p>Json</p>
                    </div>
                </div>
                <div className="flex-1 border-2 rounded-2xl bg-red-500">
