...
function LinkPreview({url}) {
  ...
  return (
    <div className="justify-items-center items-center mb-2">
      {data &&
          <img src={data.image.url} alt={data.title} className="w-28 h-28 rounded-3xl"/>
}
    </div>
  );
}
        ...
        <div className="min-h-screen bg-verdeBosque">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 px-16 py-12 justify-center text-center gap-3 bg-gradient-to-tr from-verdeOliva to-verdeBosque">
                <div className="flex-1 text-white group p-2 border-2 border-verdeOliva">
                    {LinkPreview({url: 'https://youtube.com/playlist?list=PLtDlpMIfDcOH4dt8BzlCKE-cFeC4WomAF'})}
                ...
                <div className="flex-1 text-white group p-2 border-2 border-verdeOliva">
                    ...
                    <h2 className="subtitle text-center italic group-hover:text-dorado">"Navakarana yoga, il metodo per fluire al ritmo della musica (e della luna)"</h2>
