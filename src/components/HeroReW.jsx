...
function HeroReW() {
    ...
    return (
        <div className="relative min-h-dvh w-full max-h-dvh flex flex-col items-center justify-center sm:justify-around bg-gradient-to-tr from-terracota to-dorado p-4">
            ...
            <div className="flex flex-col items-center justify-center z-30 w-full pb-10 md:pb-12 lg:pb-18">
                ...
                <a 
                    ...
                    className="hidden md:block btn-scopri group group-hover:*"
                >
