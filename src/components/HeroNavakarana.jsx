    ...
    return(
            <div className="relative h-[80vh] w-full flex flex-row items-center justify-center text-white" 
                ...
                <div className="absolute top-1/2 z-20 p-12 text-center">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl rounded font-serif text-white font-medium text-center drop-shadow-2xl uppercase
                    ">NavakaraṆa vinyāsa</h1>
                </div>
                <div className="absolute bottom-0 border-2 border-white rounded hover:border-[#581414] hover:bg-claro transition-all duration-500  px-6 py-3 my-2 flex justify-center items-center text-white hover:text-oscuro max-w-fit">
