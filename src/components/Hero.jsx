...
function Hero() {
  return (
    <div className="relative min-h-fit sm:min-h-screen w-full flex flex-row items-end justify-center text-white">
      ...
      {/* Desktop & Tablet */}
      <div className="hidden sm:block absolute inset-0 bg-[url('/images/homebg1.png')] bg-center bg-cover bg-no-repeat" />
      <div className="relative z-10 p-12 text-center">
          <h1 className="welcomeTitle p-2 md:p-4">¡BENVENUTI A UMĀ!</h1>
          <p className="font-sans text-lg md:text-xl font-normal drop-shadow-text pb-4">Uno spazio sacro di crescita ed evoluzione personale che unisce e presenta i nostri progetti e percorsi yoga e in cui yu possa riconoscerti e sentirti a casa.</p>
      </div>
